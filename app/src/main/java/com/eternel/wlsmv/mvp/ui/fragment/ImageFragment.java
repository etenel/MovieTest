...
public class ImageFragment extends BaseFragment<ImagePresenter> implements ImageContract.View, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        imageList.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false));
    ...
    private void initPaginate() {
        if (paginate == null) {
            ...
            paginate = Paginate.with(imageList, callbacks)
